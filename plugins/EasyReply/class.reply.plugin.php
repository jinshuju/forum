...
$PluginInfo['EasyReply'] = array(
   'Name' => 'EasyReply',
   'Description' => "Add a Reply Button to each post/comment(display as '@username'). Also add Ctrl+Enter Reply shortcut. 本插件用于方便用户回复. 来自东北大学先锋网技术部.由vanillaforums.cn修改",
   'Version' => '1.1',
   ...
   'Author' => "andelf,chuck911",
   'AuthorEmail' => 'andelf@gmail.com,chuck911@qq.com',
   'AuthorUrl' => 'http://www.neupioneer.com,http://vanillaforums.cn',
   'License' => 'GPLv3'
);
